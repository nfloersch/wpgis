...
public final class ImprovedNoise implements Serializable {
    ...
    public static final double HIGHEST_VALUE = Math.sqrt(0.5);
    public static final double LOWEST_VALUE = -HIGHEST_VALUE;
    public static final double RANGE = HIGHEST_VALUE - LOWEST_VALUE;
