 ...
 *
 * $Revision: 892 $
 * $Date: 2008-02-28 21:18:01 +0100 (do, 28 feb 2008) $
 * $State$
 */
...
public class Transform3D {
    ...
    */
    ...
    private static final Logger logger = Logger.getLogger(Transform3D.class.getName());
    ...
    */
    ...
    private static boolean almostOne(double a) {
    ...
    */
    ...
    private void setScaleTranslation(double x, double y,
...
//	}
	...
	if (result != m3) {
            System.arraycopy(result, 0, m3, 0, 9);
	}
    }
    ...
    static private void multipleScale(double m[] , double s[]) {
	m[0]  *= s[0];
	m[1]  *= s[0];
	m[2]  *= s[0];
	m[4]  *= s[1];
	...
	if(almostEqual(Math.abs(scales[0]), Math.abs(scales[1])) &&
	   almostEqual(Math.abs(scales[1]), Math.abs(scales[2]))   ){
	    ...
	    index = svdOut[in0];
	    if (outRot == null) {
                logger.severe("outRot == null");
            }
	    if (rot == null) {
                logger.severe("rot == null");
            }
    ...
    static private double max3( double[] values) {
    ...
    private void computeScales(boolean forceSVD) {
    ...
    private void computeScaleRotation(boolean forceSVD) {
    ...
    private boolean isInfOrNaN(Quat4f q) {
