...
public final class ColourUtils {
    ...
    public static int mix(int colour1, int colour2) {
        ...
        int green = ((colour1 & 0x00FF00) >>  9) + ((colour2 & 0x00FF00) >>  9);
        int blue  = ((colour1 & 0x0000FF) >>  1) + ((colour2 & 0x0000FF) >>  1);
        return (red << 16) | (green << 8) | blue;
    }

    public static int mix(int colour1, int colour2, int alpha) {
        int red1   = (colour1 & 0xFF0000) >> 16;
        int green1 = (colour1 & 0x00FF00) >> 8;
        int blue1  =  colour1 & 0x0000FF;
        int red2   = (colour2 & 0xFF0000) >> 16;
        int green2 = (colour2 & 0x00FF00) >> 8;
        int blue2  =  colour2 & 0x0000FF;
