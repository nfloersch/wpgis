...
public class ExportTileSelectionDialog extends javax.swing.JDialog implements WindowListener {
    ...
    public ExportTileSelectionDialog(java.awt.Dialog parent, World2 world, int selectedDimension, Set<Point> selectedTiles, ColourScheme colourScheme, BiomeScheme biomeScheme, CustomBiomeManager customBiomeManager, Collection<Layer> hiddenLayers, boolean contourLines, TileRenderer.LightOrigin lightOrigin) {
        super(parent, true);
        this.world = world;
        initComponents();
